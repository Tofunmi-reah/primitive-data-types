...
let dadIsTaller = momsHeight < dadsHeight
...
let notPlagiarised = !studentEssay.toLowerCase().includes(generateSudentEssay)
...
let correctlen = secretCode.length === 15
let codeIsValid = correct5thchar && correct10thchar && correctlen
